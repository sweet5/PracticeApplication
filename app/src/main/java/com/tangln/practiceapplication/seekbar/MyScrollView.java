...
/**
 * @author: tangln
 * @date: 2021/8/3  下午4:14
 * des:
 */
class MyScrollView extends FrameLayout {
    ...
    public MyScrollView(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    //<editor-fold defaultstate="collapsed" desc="原有方法">
    private void init() {
    ...
    public void playOrPause() {
        ...
        //结尾
        int distance = getScrollRange();
        //todo 根据距离计算动画时长
        int duration = 0;
        mScroller.startScroll(scrollX, scrollY,distance-scrollX,scrollY,duration);
    }
